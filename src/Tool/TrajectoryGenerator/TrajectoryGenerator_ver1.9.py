...
class TrajectoryModel:
    ...
    def __init__(self, left_points, right_points):
        ...
        # 初期点の設定
        self.initial_point = np.array([89669.8263482649, 43133.249359249])
        ...
        # 最終点の設定
        self.final_point = np.array([89630.067488, 43130.694559])
        ...
        # デフォルトの表示範囲
        # self.xlim = [89570, 89710]
        # self.ylim = [43110, 43210]
    ...
    def export_trajectory(self):
        ...
        with open(traj_path, 'w', newline='') as f:
            ...
            for i, p in enumerate(all_points):
                ...
                writer.writerow([p[0], p[1], 0.0, xq, yq, zq, wq, self.get_speed(count=i+2)])
    ...
    def simulate_lap_time(self):
        ...
        self.max_brake_G = 1.5   # 最大ブレーキG [G]
...
class TrajectoryView:
    ...
    def __init__(self, model):
        ...
        # 初回から固定範囲を設定
        # self.ax.set_xlim(self.model.xlim)
        # self.ax.set_ylim(self.model.ylim)
    ...
    def create_buttons(self):
        ...
        self.button_set_final = Button(plt.axes([0.82, base_y-6*step, 0.15, 0.04]), 'Set Final Point')

        # Data Reference タイトルとボタン
        ref_base = base_y-8*step
    ...
    def redraw_all(self):
        ...
        # 描画範囲を固定
        # self.ax.set_xlim(m.xlim)
        # self.ax.set_ylim(m.ylim)
        ...
        if m.lap_time_result is not None:
            self.ax.legend([f"Time = {m.lap_time_result:.3f} [s]"], loc='upper right', frameon=True)
...
class TrajectoryController:
    ...
    def __init__(self, model, view):
        ...
        self.view.button_set_final.on_clicked(self.set_final_point)      
    ...
    # --- Final Pointの内容 ---
    def set_final_point(self, event):
        """
        Final Pointをクリックされたのと同じ処理として追加
        """
        self.model.selected_points.append(self.model.final_point.copy())
        print(f"Final Point Added: {self.model.final_point}")
        self.view.redraw_all()
...
if __name__ == "__main__":
    ...
    file_path = "base_circuit_line_with_garage.csv"
    # file_path = "./../Map/lanelet_lr_center_compact.csv"
